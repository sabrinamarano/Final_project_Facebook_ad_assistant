...
#budget calculator
import pickle
loaded_model = pickle.load(open('./finalp_models/budget.sav', 'rb'))
...
clicks_model = pickle.load(open('./finalp_models/prediction_clicks.sav', 'rb'))
...
conversion_model = pickle.load(open('./finalp_models/prediction_conversions.sav', 'rb'))
